...
public class DataHierJsonDS extends BasicDataSource
{
	private final String CLASS_NAME = "DataHierJsonDS";
...
// Perform the I/O operation.
		...
		appLogger.debug(String.format("'%s': Saved '%s' (%d bytes) to '%s' folder in %d milliseconds.", scDS.getName(),
									  fileName, fileSize, Constants.DS_DATA_HIERARCHY_PATH_NAME, stopWatch.getTime()));
