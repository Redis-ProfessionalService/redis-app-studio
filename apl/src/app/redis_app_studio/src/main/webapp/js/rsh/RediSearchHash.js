var RediSearchHash = (function () {
    function RediSearchHash(anAppContext) {
        this.appContext = anAppContext;
    }
    RediSearchHash.prototype.createHTMLHeader = function () {
    ...
    RediSearchHash.prototype.createHeaderSection = function () {
    ...
    RediSearchHash.prototype.defaultCriteria = function (aDSStructure, aDSTitle, aFetchLimit) {
        var windowAppContext = window._appContext_;
        var fetchLimit;
        if (aFetchLimit)
    ...
    RediSearchHash.prototype.executeAppViewGridExport = function (anAction, aFormat, aFetchLimit) {
        var windowAppContext = window._appContext_;
    ...
    RediSearchHash.prototype.resetFacetList = function () {
        var windowAppContext = window._appContext_;
    ...
    RediSearchHash.prototype.adjustFacetName = function (aRecord) {
        var windowAppContext = window._appContext_;
    ...
    RediSearchHash.prototype.assignFacetsCallback = function () {
    ...
    RediSearchHash.prototype.fetchFacetsCallback = function () {
    ...
    RediSearchHash.prototype.executeAppViewGridSearch = function () {
        var minAdvancedCriteriaLength = 89;
        var windowAppContext = window._appContext_;
    ...
    RediSearchHash.prototype.createSearchSection = function () {
        var windowAppContext = window._appContext_;
    ...
    RediSearchHash.prototype.deleteSelectedAppViewGridRow = function (aResponse) {
        if (aResponse == "OK") {
            var windowAppViewGrid = window.appViewGrid;
            var appViewGrid = void 0;
            appViewGrid = windowAppViewGrid;
    ...
    RediSearchHash.prototype.deleteSelectedDocumentsGridRow = function (aResponse) {
        if (aResponse == "OK") {
    ...
    RediSearchHash.prototype.deleteSelectedFlatAppViewGridRow = function (aResponse) {
        if (aResponse == "OK") {
    ...
    RediSearchHash.prototype.deleteSelectedHierarchyAppViewGridRow = function (aResponse) {
        if (aResponse == "OK") {
    ...
    RediSearchHash.prototype.rebuildSearchIndex = function (aResponse) {
        if (aResponse == "OK") {
            ...
            if (schemaGrid_1 != null) {
                ...
                setTimeout(function () { schemaGrid_1.invalidateCache(); schemaGrid_1.filterData(RediSearchHash.prototype.defaultCriteria(windowAppContext_2.getDSStructure(), windowAppContext_2.getAppViewTitle())); }, 2000);
            }
        }
    };
    RediSearchHash.prototype.flushDatabase = function (aResponse) {
        if (aResponse == "OK") {
            var windowAppContext = window._appContext_;
            ...
            if ((redisDBInfoWindow != null) && (redisDBInfoForm != null)) {
                ...
                setTimeout(function () { RediSearchHash.prototype.executeAppViewGridSearch(); }, 2000);
            }
        }
    };
    RediSearchHash.prototype.updateCallback = function (aDSResponse, aData, aDSRequest) {
        isc.Notify.addMessage("Form saved", null, null, {
            canDismiss: true, appearMethod: "slide", disappearMethod: "fade", position: "T"
        });
    };
    RediSearchHash.prototype.uploadCallback = function (aDSResponse, aData, aDSRequest) {
        isc.Notify.addMessage("Upload complete", null, null, {
            canDismiss: true, appearMethod: "slide", disappearMethod: "fade", position: "T"
        });
    };
    RediSearchHash.prototype.dafNextUploadCallback = function (aDSResponse, aData, aDSRequest) {
    ...
    RediSearchHash.prototype.graphNextUploadCallback = function (aDSResponse, aData, aDSRequest) {
    ...
    RediSearchHash.prototype.createCommandToolStrip = function () {
        var windowAppContext = window._appContext_;
    ...
    RediSearchHash.prototype.createAppViewGridLayout = function () {
        var windowAppContext = window._appContext_;
    ...
    RediSearchHash.prototype.createCommandGrid = function () {
        var windowAppContext = window._appContext_;
    ...
    RediSearchHash.prototype.createFacetGrid = function () {
    ...
    RediSearchHash.prototype.init = function () {
    ...
    RediSearchHash.prototype.show = function () {
        this.appLayout.show();
    };
    RediSearchHash.prototype.hide = function () {
        this.appLayout.hide();
    };
    return RediSearchHash;
}());
//# sourceMappingURL=RediSearchHash.js.map