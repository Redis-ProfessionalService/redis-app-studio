var RedisJson = (function () {
    function RedisJson(anAppContext) {
        this.appContext = anAppContext;
    }
    RedisJson.prototype.createHTMLHeader = function () {
    ...
    RedisJson.prototype.createHeaderSection = function () {
    ...
    RedisJson.prototype.defaultCriteria = function (aDSStructure, aDSTitle, aFetchLimit) {
        var windowAppContext = window._appContext_;
        var fetchLimit;
        if (aFetchLimit)
    ...
    RedisJson.prototype.executeAppViewGridExport = function (anAction, aFormat, aFetchLimit) {
        var windowAppContext = window._appContext_;
    ...
    RedisJson.prototype.executeAppViewGridFetch = function () {
    ...
    RedisJson.prototype.deleteSelectedAppViewGridRow = function (aResponse) {
        if (aResponse == "OK") {
            var windowAppViewGrid = window.appViewGrid;
    ...
    RedisJson.prototype.deleteSelectedDocumentsGridRow = function (aResponse) {
        if (aResponse == "OK") {
    ...
    RedisJson.prototype.deleteSelectedFlatAppViewGridRow = function (aResponse) {
        if (aResponse == "OK") {
    ...
    RedisJson.prototype.deleteSelectedHierarchyAppViewGridRow = function (aResponse) {
        if (aResponse == "OK") {
    ...
    RedisJson.prototype.rebuildDatabase = function (aResponse) {
        if (aResponse == "OK") {
    ...
    RedisJson.prototype.flushDatabase = function (aResponse) {
        if (aResponse == "OK") {
            var windowAppContext = window._appContext_;
            ...
            if ((redisDBInfoWindow != null) && (redisDBInfoForm != null)) {
                ...
                setTimeout(function () { RedisJson.prototype.executeAppViewGridFetch(); }, 2000);
            }
        }
    };
    RedisJson.prototype.updateCallback = function (aDSResponse, aData, aDSRequest) {
        isc.Notify.addMessage("Form saved", null, null, {
            canDismiss: true, appearMethod: "slide", disappearMethod: "fade", position: "T"
        });
    };
    RedisJson.prototype.uploadCallback = function (aDSResponse, aData, aDSRequest) {
        isc.Notify.addMessage("Upload complete", null, null, {
            canDismiss: true, appearMethod: "slide", disappearMethod: "fade", position: "T"
        });
    };
    RedisJson.prototype.dafNextUploadCallback = function (aDSResponse, aData, aDSRequest) {
    ...
    RedisJson.prototype.graphNextUploadCallback = function (aDSResponse, aData, aDSRequest) {
    ...
    RedisJson.prototype.createCommandToolStrip = function () {
        var windowAppContext = window._appContext_;
    ...
    RedisJson.prototype.createAppViewGrid = function () {
        var windowAppContext = window._appContext_;
    ...
    RedisJson.prototype.createCommandGrid = function () {
        var windowAppContext = window._appContext_;
    ...
    RedisJson.prototype.init = function () {
    ...
    RedisJson.prototype.show = function () {
        this.appLayout.show();
    };
    RedisJson.prototype.hide = function () {
        this.appLayout.hide();
    };
    return RedisJson;
}());
//# sourceMappingURL=RedisJson.js.map